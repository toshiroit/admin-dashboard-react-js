...
import CategoryList from 'pages/apps/e-commerce/category-list';
...
const AppECommShopList = Loadable(lazy(() => import('pages/apps/e-commerce/shops-list')));
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  element: <div>Add new category</div>
                }
              ]
            }
          ]
