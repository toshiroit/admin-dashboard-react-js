...
const Checkout = () => {
  ...
  return (
    <MainCard
      title="Danh sách người dùng đăng kí bán hàng tại Shop"
      subheader="Danh sách được cập nhật thường xuyên khi có khách hàng mới đăng kí và sẽ được hiện thị tại đây "
      content={false}
    >
      <ScrollX>
